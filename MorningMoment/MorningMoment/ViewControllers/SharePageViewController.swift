...
class SharePageViewController: UIViewController {
    ...
    // load selected page from table from share view controller
    ...
    // function to take screenshot of current screen to send
    ...
    // ask for permissions if Contacts is not accessible
